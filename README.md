 ...
 * fribidi 1.0.14 (LGPL 2.1)
 * gettext 0.22.4 (only libintl : LGPL 2.1)
 * giflib 5.2.2 (MIT)
 * glib2 2.76.3 (LGPL 2.1)
 * graphene 1.10.8 (MIT)
 * graphite2 1.3.14 (LGPL 2.1)
 * gst-libav 1.24.1 (LGPL 2.1)
 * gst-plugins-base 1.24.1 (LGPL 2.1)
 * gst-plugins-good 1.24.1 (LGPL 2.1)
 * gstreamer 1.24.1 (LGPL 2.1)
 * harfbuzz 8.4.0 (MIT)
