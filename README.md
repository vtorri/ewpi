 ...
 * gettext 0.22.3 (only libintl : LGPL 2.1)
 * giflib 5.2.1 (MIT)
 * glib2 2.76.3 (LGPL 2.1)
 * graphene 1.10.8 (MIT)
 * graphite2 1.3.14 (LGPL 2.1)
 * gst-libav 1.22.8 (LGPL 2.1)
 * gst-plugins-base 1.22.8 (LGPL 2.1)
 * gst-plugins-good 1.22.8 (LGPL 2.1)
 * gstreamer 1.22.8 (LGPL 2.1)
 * harfbuzz 8.3.0 (MIT)
 ...
 * libopenh264 2.4.0 (BSD 2-clause)
 * libopenmpt 0.7.3 (BSD 3-clause)
 * libpng 1.6.41 (BSD 3-clause)
 * libpsl 0.21.5 (MIT)
