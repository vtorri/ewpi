 ...
 * freetype 2.13.1 (FreeType license)
 ...
 * gst-libav 1.22.3 (LGPL 2.1)
 * gst-plugins-base 1.22.3 (LGPL 2.1)
 * gst-plugins-good 1.22.3 (LGPL 2.1)
 * gstreamer 1.22.3 (LGPL 2.1)
 * harfbuzz 8.0.1 (MIT)
 * highway 1.0.5 (Apache 2.0)
